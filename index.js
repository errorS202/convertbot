...
bot.command(['start', 'help'], async (ctx) => {
    const messages = `
تم تغيير البوت السابق 😔، ونأسف لذلك. كل رقم تتبع سجلتموه محفوظ وستجدونه في البوت الجديد الذي تم إطلاقه بنفس الصفات والخصائص السابقة. نأمل أن تجدوا البوت الجديد مفيدًا وممتعًا كما كان السابق. شكرًا لدعمكم وتفهمكم.   `
    const replyMarkup2 = {
        inline_keyboard: [
